...
def main():
    chromosomes_list = [create_chromosome(22), create_chromosome(22), create_chromosome(22), create_chromosome(22), create_chromosome(22),
    create_chromosome(22), create_chromosome(22), create_chromosome(22), create_chromosome(22), create_chromosome(22)]
    ch = selection(chromosomes_list)

    print(crossover(ch[0],ch[1]))
